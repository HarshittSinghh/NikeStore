...
import 'package:nike_store/Cart/cart_model.dart';
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network(
                          'https://cdn.wallpapersafari.com/51/91/OmXj7V.jpg',
                          fit: BoxFit.cover,
                          width: 350,
                          height: 225,
                        ),
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network(
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRcT7hMdqT85Bx1a59Nk42SlCA-H6MJ8R4hdwoWYSesQGS5OekNrmy-fRXA4OOLXxOVpA&usqp=CAU',
                          fit: BoxFit.cover,
                          width: 350,
                          height: 225,
                        ),
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network(
                          'https://i.ytimg.com/vi/fYBCkz06vmQ/maxresdefault.jpg',
                          fit: BoxFit.cover,
                          width: 350,
                          height: 225,
                        ),
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network(
                          'https://wallpapers.com/images/hd/roger-federer-nike-poster-w28yqyes3uef4vrp.jpg',
                          fit: BoxFit.cover,
                          width: 350,
                          height: 225,
                        ),
